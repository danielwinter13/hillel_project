...
//    }
    public static boolean endsWith(String firstString, String secondString) {
        if (firstString.length() >= secondString.length()) {
            ...
            System.out.println(firstString.substring(lengthDifference));
            if (firstString.substring(lengthDifference).equalsIgnoreCase(secondString)){
                return true;
            }else return false;
        }else{
            int lengthDifference = secondString.length() - firstString.length();
            System.out.println(secondString.substring(lengthDifference));
            if (secondString.substring(lengthDifference).equalsIgnoreCase(firstString)){
                return true;
            }else return false;
        }
    }
