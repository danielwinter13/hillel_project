...
public class NewString {
    public static void main(String[] args) {
        ...
        int[] task4_1 = {1, 2, 2, 1};
        sumWithoutUnlucky13(task4_1);
        int[] task4_2 = {1, 1};
        sumWithoutUnlucky13(task4_2);
        int[] task4_3 = {1, 2, 13, 2, 1, 13};
        sumWithoutUnlucky13(task4_3);
        int[] task4_4 = {};
        sumWithoutUnlucky13(task4_4);
    ...
    public static void sumWithoutUnlucky13(int[] array4) {
        int sum = 0;
